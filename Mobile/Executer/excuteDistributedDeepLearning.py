...
class operation:
    ...
    def __init__(self, operation_id, generation_operation_model, input_shape):
        import numpy as np

        self.operation_id = operation_id
        self.operation_model = None
        # self.operation_model = generation_operation_model
        self.generate_model = generation_operation_model
    ...
    def excute(self, input):
        ...
        operation_model = self.generate_model(self.input_shape)
        ...
        for name in weights:
            try:
                if operation_model.get_layer(name) != None:
                    weights_dict = utils.load_weights_by_name(name)
                    operation_model.get_layer(name).set_weights(weights_dict[name])
...
class excuteDistributedDeepLearningAgent:
    ...
    def __init__(self):
        ...
        self.operation_func = []
        self.operations = []
        self.operations_input_shape = []
        # weights_dict = utils.load_weights()

        self.operations_input_shape.append((96, 96, 3))
        self.operations_input_shape.append((12, 12, 192))
        self.operations_input_shape.append((12, 12, 192))
        self.operations_input_shape.append((12, 12, 192))
        self.operations_input_shape.append((12, 12, 192))
        self.operations_input_shape.append([(12, 12, 128), (12, 12, 32), (12, 12, 32), (12, 12, 64)])
        self.operations_input_shape.append((12, 12, 256))
        self.operations_input_shape.append((12, 12, 256))
        self.operations_input_shape.append((12, 12, 256))
        self.operations_input_shape.append((12, 12, 256))
        self.operations_input_shape.append([(12, 12, 128), (12, 12, 64), (12, 12, 64), (12, 12, 64)])
        self.operations_input_shape.append((12, 12, 320))
        self.operations_input_shape.append((12, 12, 320))
        self.operations_input_shape.append((12, 12, 320))
        self.operations_input_shape.append([(6, 6, 256), (6, 6, 64), (6, 6, 320)])
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append([(6, 6, 192), (6, 6, 64), (6, 6, 128), (6, 6, 256)])
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append((6, 6, 640))
        self.operations_input_shape.append([(3, 3, 256), (3, 3, 128), (3, 3, 640)])
        self.operations_input_shape.append((3, 3, 1024))
        self.operations_input_shape.append((3, 3, 1024))
        self.operations_input_shape.append((3, 3, 1024))
        self.operations_input_shape.append([(3, 3, 384), (3, 3, 96), (3, 3, 256)])
        self.operations_input_shape.append((3, 3, 736))
        self.operations_input_shape.append((3, 3, 736))
        self.operations_input_shape.append((3, 3, 736))
        self.operations_input_shape.append([(3, 3, 384), (3, 3, 96), (3, 3, 256)])
        self.operations_input_shape.append((3, 3, 736))

        self.operation_func.append(self.__func0__)
        self.operation_func.append(self.__func1__)
        self.operation_func.append(self.__func2__)
        self.operation_func.append(self.__func3__)
        self.operation_func.append(self.__func4__)
        self.operation_func.append(self.__func5__)
        self.operation_func.append(self.__func6__)
        self.operation_func.append(self.__func7__)
        self.operation_func.append(self.__func8__)
        self.operation_func.append(self.__func9__)
        self.operation_func.append(self.__func10__)
        self.operation_func.append(self.__func11__)
        self.operation_func.append(self.__func12__)
        self.operation_func.append(self.__func13__)
        self.operation_func.append(self.__func14__)
        self.operation_func.append(self.__func15__)
        self.operation_func.append(self.__func16__)
        self.operation_func.append(self.__func17__)
        self.operation_func.append(self.__func18__)
        self.operation_func.append(self.__func19__)
        self.operation_func.append(self.__func20__)
        self.operation_func.append(self.__func21__)
        self.operation_func.append(self.__func22__)
        self.operation_func.append(self.__func23__)
        self.operation_func.append(self.__func24__)
        self.operation_func.append(self.__func25__)
        self.operation_func.append(self.__func26__)
        self.operation_func.append(self.__func27__)
        self.operation_func.append(self.__func28__)
        self.operation_func.append(self.__func29__)
        self.operation_func.append(self.__func30__)
        self.operation_func.append(self.__func31__)
        self.operation_func.append(self.__func32__)
        #

        #
        self.operations = []
        for operationid in range(len(self.operations_input_shape)):
            self.operations.append(
            operation(operationid, self.operation_func[operationid], self.operations_input_shape[operationid]))
