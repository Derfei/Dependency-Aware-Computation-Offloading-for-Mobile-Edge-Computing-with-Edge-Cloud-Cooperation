...
class operation:
    ...
    def load_weight(self):
        ...
        WEIGHT_MODEL = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.2/resnet50_weights_tf_dim_ordering_tf_kernels.h5'
        ...
        'load the weights'
        weight_file = get_file(filename, WEIGHT_MODEL, cache_subdir='models')
        self.operation_model.load_weights(filepath=weight_file, by_name=True)
...
class excuteResnet50:
    ...
    def __func33__(self, input_shape):
        from keras.layers import Input
        from keras.layers import Activation
        from keras.layers import Conv2D
        from keras.layers import BatchNormalization
    ...
    def __func34__(self, input_shape):
        from keras.layers import Input
        from keras import layers
        from keras.layers import Activation
        from keras.models import Model
    ...
    def __func35__(self, input_shape):
        from keras.layers import Input
        from keras.layers import Activation
        from keras.layers import Conv2D
        from keras.layers import BatchNormalization
    ...
    def __func36__(self, input_shape):
        from keras.layers import Input
        from keras import layers
        from keras.layers import Activation
        from keras.models import Model
    ...
    def __func37__(self, input_shape):
        from keras.layers import Input
    ...
    def __init__(self):
        ...
        operation9 = operation(9, self.__func9__, (55, 55, 256), weights_model)
        ...
        operation14 = operation(14, self.__func14__, [(28, 28, 512), (28, 28, 512)], weights_model)
        operation15 = operation(15, self.__func15__, (28, 28, 512), weights_model)
        operation16 = operation(16, self.__func16__, [(28, 28, 512), (28, 28, 512)], weights_model)
        operation17 = operation(17, self.__func17__, (28, 28, 512), weights_model)
        operation18 = operation(18, self.__func18__, (28, 28, 512), weights_model)
        ...
        operation25 = operation(25, self.__func25__, [(14, 14, 1024), (14, 14, 1024)], weights_model)
        operation26 = operation(26, self.__func26__, (14, 14, 1024), weights_model)
        operation27 = operation(27, self.__func27__, [(14, 14, 1024), (14, 14, 1024)], weights_model)
        operation28 = operation(28, self.__func28__, (14, 14, 1024), weights_model)
        operation29 = operation(29, self.__func29__, [(14, 14, 1024), (14, 14, 1024)], weights_model)
        operation30 = operation(30, self.__func30__, (14, 14, 1024), weights_model)
        operation31 = operation(31, self.__func31__, (14, 14, 1024), weights_model)
        operation32 = operation(32, self.__func32__, [(7, 7, 2048), (7, 7, 2048)], weights_model)
        operation33 = operation(33, self.__func33__, (7, 7, 2048), weights_model)
        operation34 = operation(34, self.__func34__, [(7, 7, 2048), (7, 7, 2048)], weights_model)
        operation35 = operation(35, self.__func35__, (7, 7, 2048), weights_model)
        operation36 = operation(36, self.__func36__, [(7, 7, 2048), (7, 7, 2048)], weights_model)
        operation37 = operation(37, self.__func37__, (7, 7, 2048), weights_model)
        ...
        self.operations.append(operation33)
        self.operations.append(operation34)
        self.operations.append(operation35)
        self.operations.append(operation36)
        self.operations.append(operation37)
...
if __name__ == "__main__":
    agent = excuteResnet50()
    workload = []
    for tmp in agent.operations:
        workload.append(tmp.input_shape)