...
class excuteVgg16boostVgg19_greedy1:
    ...
    def __init__(self):
        ...
        operation4 = operation(4, self.__func5__, (56, 56, 128), weights_model_vgg16, weights_model_vgg19)
        operation5 = operation(5, self.__func13__, [(28, 28, 256), (28, 28, 256)], weights_model_vgg16, weights_model_vgg19)
