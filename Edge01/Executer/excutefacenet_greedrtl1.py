...
class excuteDistributedDeepLearningAgent_greedyrtl1:
    ...
    def __func4__(self, input_shape):
        ...
        model = Model(inputs=inception_3c,
    ...
    def __init__(self):
        ...
        operation2 = operation(2, self.__func2__, (12, 12, 256), weights_dict)
        operation3 = operation(3, self.__func3__, (12, 12, 320), weights_dict)
        operation4 = operation(4, self.__func4__, (6, 6, 640), weights_dict)
        operation5 = operation(5, self.__func5__, (6, 6, 640),
                               weights_dict)
        operation6 = operation(6, self.__func6__, (6, 6, 640), weights_dict)
        operation7 = operation(7, self.__func7__, (6, 6, 640), weights_dict)
        operation8 = operation(8, self.__func8__, [(3, 3, 256), (3, 3, 128), (3, 3, 640)], weights_dict)
        operation9 = operation(9, self.__func9__, (3, 3, 1024), weights_dict)
        operation10 = operation(10, self.__func10__, (3, 3, 1024),
                               weights_dict)
        operation11 = operation(11, self.__func11__, (3, 3, 1024), weights_dict)
        operation12 = operation(12, self.__func12__, [(3, 3, 384), (3, 3, 96), (3, 3, 256)], weights_dict)
        operation13 = operation(13, self.__func13__, (3, 3, 736), weights_dict)
